...
public class ModuleIOReal implements ModuleIO {
  ...
  public ModuleIOReal(
    ...
    driveTalon = new TalonFX(constants.DriveMotorId, Constants.Swerve.CanBus);
    turnTalon = new TalonFX(constants.SteerMotorId, Constants.Swerve.CanBus);
    cancoder = new CANcoder(constants.EncoderId, Constants.Swerve.CanBus);
