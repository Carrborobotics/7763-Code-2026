...
public class RackIOInputsAutoLogged extends RackIO.RackIOInputs implements LoggableInputs, Cloneable {
    ...
    public RackIOInputsAutoLogged clone() {
        RackIOInputsAutoLogged copy = new RackIOInputsAutoLogged();
